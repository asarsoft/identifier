<nav class="navbar navbar-expand-lg bg-white navbar-light mb-5 shadow-sm position-sticky web_navbar">
    <a class="navbar-brand d-lg-none" href="#">{{ trans('app.name') }}</a>
	...
	<div class="collapse navbar-collapse justify-content-md-center" id="navigations-02">
		<div class="row w-100">
			...
			<div class="col-4 navbar-nav text-center pr-0 d-none d-lg-block"><a class="navbar-brand mr-0" href="#">{{ trans('app.name') }}</a></div>
